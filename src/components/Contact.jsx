            ...
            <form className="form-contact">
              <div className="row g-3">
                <div className="col-md-6">
                  <input type="text" className="form-control border-0 bg-light px-4" placeholder="Your Name" style={{ height: '55px', outline: 'none' }} />
                </div>
                <div className="col-md-6">
                ...
                <div className="col-12">
                  <textarea className="form-control border-0 bg-light px-4 py-3" rows="6" placeholder="Message"></textarea>
                </div>
                <div className="col-12">
                  <button className="btn w-100 py-3 text-white" style={{backgroundColor:"#06A3DA"}} type="submit">
                    Send Message
                  </button>
                </div>
              </div>
